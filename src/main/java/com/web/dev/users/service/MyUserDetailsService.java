...
import com.web.dev.users.dao.UserDetailsDao;
...
public class MyUserDetailsService implements  UserDetailsService {
	...
	public UserDetails loadUserByUsername(final String username) throws UsernameNotFoundException {
		...
		com.web.dev.users.model.User user = userDao.findByUserName(username);
		List<GrantedAuthority> authorities = buildUserAuthority(user.getUserRole());
	...
	private User buildUserForAuthentication(com.web.dev.users.model.User user, List<GrantedAuthority> authorities) {
